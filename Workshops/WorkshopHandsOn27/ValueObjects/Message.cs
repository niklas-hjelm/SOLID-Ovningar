...
namespace WorkshopHandsOn27.ValueObjects
{
    public class Message
    {
        ...
        public static Message Create(NetworkID sender, string text) => new Message(sender, NetworkID.Create(string.Empty, string.Empty), text);

        public static Message Create(NetworkID sender, NetworkID recipient, string text)
        {
